...
/// Each event references an asset filename. Phase 1 ships synthesised
/// .wav placeholders generated by `tools/synth_sounds.py` — replace any
/// of them with a real .wav (or update the filename to .mp3/.ogg) once
/// real audio is sourced.
enum SoundEvent {
