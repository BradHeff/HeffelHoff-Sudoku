...
/// Material 3 themes. Default seed is the Material baseline deep violet
/// (#6750A4). A neon alternate (#00E0FF) ships in Phase 4 via settings.
class AppTheme {
  static const Color seedDefault = Color(0xFF6750A4);
  static const Color seedNeon = Color(0xFF00E0FF);
